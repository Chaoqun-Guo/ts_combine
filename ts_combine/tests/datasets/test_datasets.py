...
from ts_combine.utils.timeseries_generation import gaussian_timeseries

logger = get_logger(__name__)

try:
    from ts_combine.utils.data import (  # noqa: F401
...
if TORCH_AVAILABLE:
    ...
    class DatasetTestCase(DartsBaseTestClass):
        ...
        def test_get_matching_index(self):
            from ts_combine.utils.data.utils import _get_matching_index
