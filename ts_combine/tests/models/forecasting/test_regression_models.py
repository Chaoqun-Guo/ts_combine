...
from ts_combine.metrics import mae, rmse
...
from ts_combine.models.forecasting.forecasting_model import GlobalForecastingModel
from ts_combine.tests.base_test_class import DartsBaseTestClass
from ts_combine.utils import timeseries_generation as tg
from ts_combine.utils.data.encoders import FutureCyclicEncoder, PastDatetimeAttributeEncoder
...
class RegressionModelsTestCase(DartsBaseTestClass):
    ...
    @patch.object(
        ts_combine.models.forecasting.gradient_boosted_model.lgb.LGBMRegressor, "fit"
    )
    ...
    @patch.object(ts_combine.models.forecasting.catboost_model.CatBoostRegressor, "fit")
