...
from ts_combine.datasets import AirPassengersDataset
from ts_combine.utils.logging import get_logger
from ts_combine.metrics import mape
from ts_combine.tests.base_test_class import DartsBaseTestClass
from ts_combine.utils import timeseries_generation as tg
from ts_combine.utils.timeseries_generation import linear_timeseries
...
try:
    ...
    from ts_combine.models.forecasting.torch_forecasting_model import (
        DualCovariatesTorchModel,
        MixedCovariatesTorchModel,
        PastCovariatesTorchModel,
    )
    from ts_combine.utils.likelihood_models import GaussianLikelihood
...
if TORCH_AVAILABLE:
    ...
    class GlobalForecastingModelsTestCase(DartsBaseTestClass):
        ...
        def setUp(self):
            self.temp_work_dir = tempfile.mkdtemp(prefix="ts_combine")
        ...
        @patch(
            "ts_combine.models.forecasting.torch_forecasting_model.TorchForecastingModel._init_trainer"
        )
