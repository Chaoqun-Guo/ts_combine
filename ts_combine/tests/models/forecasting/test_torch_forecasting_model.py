...
if TORCH_AVAILABLE:
    ...
    class TestTorchForecastingModel(DartsBaseTestClass):
        ...
        @patch(
            "ts_combine.models.forecasting.torch_forecasting_model.TorchForecastingModel.save"
        )
        ...
        @patch(
            "ts_combine.models.forecasting.torch_forecasting_model.TorchForecastingModel.reset_model"
        )
