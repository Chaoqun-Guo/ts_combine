...
from ts_combine import metrics
from ts_combine.logging import get_logger, raise_if, raise_if_not, raise_log
from ts_combine.timeseries import TimeSeries
from ts_combine.utils import (
    _build_tqdm_iterator,
    _historical_forecasts_general_checks,
    _parallel_apply,
    _with_sanity_checks,
)
from ts_combine.utils.data.encoders import SequentialEncoder
from ts_combine.utils.timeseries_generation import (
    ...
    def save(self, path: Optional[Union[str, BinaryIO]] = None, **pkl_kwargs) -> None:
        ...
        Example for saving and loading a :class:`RegressionModel`:
            ...
            .. code-block:: python
                ...
                from ts_combine.models import RegressionModel
