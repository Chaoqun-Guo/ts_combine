...
from ts_combine.models.forecasting.forecasting_model import ForecastingModel
from ts_combine.timeseries import TimeSeries
from ts_combine.utils.statistics import (
    check_seasonality,
    extract_trend_and_seasonality,
    remove_from_series,
)
from ts_combine.utils.utils import ModelMode, SeasonalityMode, TrendMode
...
class Theta(ForecastingModel):
    ...
    def __init__(
        ...
        You can access the Enum with ``from ts_combine import SeasonalityMode``.
...
class FourTheta(ForecastingModel):
    def __init__(
        ...
        You can access the different Enums with ``from ts_combine import SeasonalityMode, TrendMode, ModelMode``.
    ...
    def select_best_model(
        ...
        from ts_combine.metrics import mae
