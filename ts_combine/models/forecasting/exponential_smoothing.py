...
from ts_combine.utils.utils import ModelMode, SeasonalityMode
...
class ExponentialSmoothing(ForecastingModel):
    def __init__(
        ...
        **fit_kwargs,
        ...
        `model_mode` must be a ``ModelMode`` Enum member. You can access the Enum with ``from ts_combine import ModelMode``.
