...
from ts_combine.models.components.transformer import (
    CustomFeedForwardDecoderLayer,
    CustomFeedForwardEncoderLayer,
)
from ts_combine.models.forecasting.pl_forecasting_module import PLPastCovariatesModule
from ts_combine.models.forecasting.torch_forecasting_model import PastCovariatesTorchModel
...
def _generate_coder(
    ...
    layer_cls
        Either `ts_combine.models.components.transformer.CustomFeedForwardEncoderLayer` or
        `...CustomFeedForwardDecoderLayer`
    ffn_cls
        One of Darts' Position-wise Feed-Forward Network variants `from ts_combine.models.components.glu_variants`
    """
    layer = layer_cls(
