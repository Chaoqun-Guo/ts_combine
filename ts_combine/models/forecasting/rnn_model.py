...
from ts_combine.logging import get_logger, raise_if_not
from ts_combine.models.forecasting.pl_forecasting_module import PLDualCovariatesModule
from ts_combine.models.forecasting.torch_forecasting_model import DualCovariatesTorchModel
from ts_combine.timeseries import TimeSeries
from ts_combine.utils.data import DualCovariatesShiftedDataset, TrainingDataset
...
class _RNNModule(PLDualCovariatesModule):
    def __init__(
        ...
        **kwargs
            all parameters required for :class:`ts_combine.model.forecasting_models.PLForecastingModule` base class.
    ...
    def __init__(
        ...
        * GRU
        ...
        model
            ...
            `ts_combine.models.rnn_model._RNNModule`.
        hidden_dim
        ...
        training_length
            ...
            inference. For more information on this parameter, please see `ts_combine.utils.data.ShiftedDataset`
        **kwargs
        ...
        likelihood
            One of Darts' :meth:`Likelihood <ts_combine.utils.likelihood_models.Likelihood>` models to be used for
