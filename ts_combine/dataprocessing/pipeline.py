...
from ts_combine.dataprocessing.transformers import (
    BaseDataTransformer,
...
class Pipeline:
    def __init__(
        ...
        >>> from ts_combine.dataprocessing.transformers import Scaler, MissingValuesFiller
        >>> from ts_combine.dataprocessing.pipeline import Pipeline
