...
``TimeSeries`` is the main class in `ts_combine`.
...
``TimeSeries`` can contain global or component-specific static covariate data. Static covariates in `ts_combine` refers
...
class TimeSeries:
    ...
    def plot(
        ...
        **kwargs,
        ...
        default_formatting
            Whether or not to use the ts_combine default scheme.
        args
    ...
    def __getitem__(
        ...
        """Allow indexing on ts_combine TimeSeries.
...
def concatenate(
    ...
    if axis == 0:
        ...
        if not consecutive_time_axes:
            ...
            from ts_combine.utils.timeseries_generation import _generate_index
