...
*   SequentialEncoder
        ...
        :meth:`SequentialEncoder <ts_combine.utils.data.encoders.SequentialEncoder>`.
...
from ts_combine import TimeSeries, concatenate
from ts_combine.dataprocessing.transformers import FittableDataTransformer
from ts_combine.utils.logging import get_logger, raise_if, raise_if_not
from ts_combine.utils.timeseries import DIMS
from ts_combine.utils.data.encoder_base import (
...
from ts_combine.utils.data.utils import _index_diff
from ts_combine.utils.timeseries_generation import datetime_attribute_timeseries
...
class CyclicTemporalEncoder(SingleEncoder):
    def __init__(self, index_generator: CovariateIndexGenerator, attribute: str):
        ...
        attribute
            ...
            <ts_combine.utils.timeseries_generation.datetime_attribute_timeseries>`
        """
    ...
    def __init__(
        ...
        *   Only kwarg `add_encoders` of type `Optional[Dict]` will be used to extract the encoders.
        ...
        Supported encoder keywords:
            ...
            :meth:`CyclicTemporalEncoder <ts_combine.utils.data.encoders.CyclicTemporalEncoder>`;
            `'datetime_attribute'` for adding scalar information of pd.DatetimeIndex attribute. See the docs
            :meth:`DatetimeAttributeEncoder <ts_combine.utils.data.encoders.DatetimeAttributeEncoder>`
            `'position'` for integer index position encoder. See the docs
            :meth:`IntegerIndexEncoder <ts_combine.utils.data.encoders.IntegerIndexEncoder>`;
            `'custom'` for encoding index with custom callables (functions). See the docs
            :meth:`CallableIndexEncoder <ts_combine.utils.data.encoders.CallableIndexEncoder>`;
        ...
        Supported transformers:
            ...
            <ts_combine.dataprocessing.transformers.fittable_data_transformer.FittableDataTransformer>` such as Scaler() or
        ...
        An example of a valid `add_encoders` dict for hourly data:
            ...
            .. code-block:: python
                ...
                from ts_combine.dataprocessing.transformers import Scaler
                add_encoders={
                    'cyclic': {'future': ['month']},
