...
from ts_combine.logging import get_logger, raise_if, raise_if_not, raise_log
...
def extract_trend_and_seasonality(
    ...
    **kwargs,
    ...
    model
        ...
        Must be ``from ts_combine import ModelMode, SeasonalityMode`` Enum member.
...
def remove_from_series(
    ...
    model
        ...
        Must be `from ts_combine import ModelMode, SeasonalityMode` Enums member.
        Either MULTIPLICATIVE or ADDITIVE.
    Returns
    -------
    TimeSeries
...
def remove_seasonality(
    ...
    **kwargs,
    ...
    model
        The type of decomposition to use.
        Must be a `from ts_combine import SeasonalityMode` Enum member.
...
def remove_trend(
    ...
    **kwargs,
    ...
    model
        The type of decomposition to use.
        Must be a `from ts_combine import ModelMode` Enum member.
